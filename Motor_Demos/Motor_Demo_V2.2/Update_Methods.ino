// updates all the cordinate variable and converts theta into a numerical angle so its easier to visualize
void update() {
...
// prints all cordinate varibales too vision system
void printToSystem()
{
